...
#include "/lib/voxelization/reflectionVoxelData.glsl"
    ...
    void UpdateSceneVoxelMap(int mat, vec3 normal, vec3 position) {
        ...
        if (CheckInsideSceneVoxelVolume(voxelPos)) {
            ...
            if (mat == 10695) { // Regular Sculk Veins
                doSolidBlockCheck = false;
            }
            ...
            if (mat == 10669 || mat == 10843|| mat == 10845 || mat == 10925 || mat == 10927 || mat == 10953) { // Wool Carpets, Moss Carpet, Pale Moss Carpet, Snow Layers < 8
                if (normal.y > 0.5) {
                    voxelPos.y -= 1.0;
                    doSolidBlockCheck = false;
                } else return;
